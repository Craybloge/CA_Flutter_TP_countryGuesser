...
class Country {
 ...
 Country(this.name, this.capital, this.continent, this.population, this.image, this.flag);

  factory Country.fromJson(Map<String, dynamic> json) {
   final String name = json['translations']['fra']['common'];
   final String capital = json['capital'][0];
  //  final String currency = json['currencies'][json['currencies'].keys[0]]['name'];
   ...
   final String image = "https://raw.githubusercontent.com/djaiss/mapsicon/master/all/${json['cca2'].toLowerCase()}/vector.svg";
